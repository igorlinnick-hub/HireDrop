// User-Agent pool for Phase 5.1 — sampled per campaign session.
// Curated to match recent (2026 Q2) Chrome stable on macOS / Windows / Linux
// so the platform/version doesn't itself become a fingerprint mismatch.
// Refresh this list a few times a year — outdated UAs are themselves a flag.
...
const UA_POOL = [
  ...
  // Edge (Chromium-based — same engine, different brand string)
